...
- [`docs/prompts/review-code.prompt.md`](docs/prompts/review-code.prompt.md) — align code-review dimensions with `sdd-review` using six compact areas, including DX, tooling, traceability, and compatibility without adding SDD delivery routing
