...
| --- | --- | --- |
| 1 | [software-engineering-rationale.md](./software-engineering-rationale.md) | Understand **why** this repo is shaped this way |
...
| --- | --- | --- |
| [software-engineering-rationale.md](./software-engineering-rationale.md) | **This repo**: principles, thinking, anti-patterns | living |
