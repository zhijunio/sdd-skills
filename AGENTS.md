...
- **Ten skills** under `skills/*/SKILL.md` — six core loop + optional **`sdd-worktree`** (pre-loop), **`sdd-publish`** (post-loop), **`sdd-improve`**, and **`sdd-zoom`**.
...
- Before merge: ten skills present; **`sdd-improve`** / **`sdd-review`** references intact; spot-check Markdown links you edit. Details: [README — Maintainer verification](README.md#maintainer-verification).
